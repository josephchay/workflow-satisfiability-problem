...
entry_1 = timetablinggui.GUIEntry(app, width=100, height=25)
entry_1.pack(padx=20, pady=20)
entry_2 = timetablinggui.GUIEntry(app, width=100, height=25)
entry_2.pack(padx=20, pady=20)

txt_var = timetablinggui.StringVar(value="test")
