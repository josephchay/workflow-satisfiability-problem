...
tabview_1 = timetablinggui.GUITabview(app)
...
b2 = timetablinggui.GUIButton(master=tabview_1.tab("tab 2"), text="button tab 2")
b2.pack()
...
for i in range(10):
    for j in range(30):
        button = timetablinggui.GUIButton(tabview_1.tab("tab 1"), height=10, width=30, font=timetablinggui.GUIFont(size=8))
