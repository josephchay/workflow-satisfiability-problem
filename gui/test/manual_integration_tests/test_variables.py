...
app = timetablinggui.TimetablingGUI()  # create GUI window likewise of the same style like the normal Tk window (you can also use normal tkinter.Tk window)
...
entry_1 = timetablinggui.GUIEntry(app, width=200, textvariable=txt_var, placeholder_text="placeholder")
...
label_1 = timetablinggui.GUILabel(app, width=200, textvariable=txt_var)
...
button_1 = timetablinggui.GUIButton(app, width=200, textvariable=txt_var)
...
slider_1 = timetablinggui.GUISlider(app, width=200, from_=0, to=3, variable=int_var)
slider_1.pack(pady=15)
if TEST_CONFIGURE: slider_1.configure(variable=int_var)
if TEST_REMOVING: slider_1.configure(variable="")
int_var.set(2)

slider_2 = timetablinggui.GUISlider(app, width=200, from_=0, to=3, variable=int_var)
slider_2.pack(pady=15)
if TEST_CONFIGURE: slider_2.configure(variable=int_var)
if TEST_REMOVING: slider_2.configure(variable="")

label_2 = timetablinggui.GUILabel(app, width=200, textvariable=int_var)
label_2.pack(pady=15)

progress_1 = timetablinggui.GUIProgressBar(app, width=200, variable=int_var)
...
check_1 = timetablinggui.GUICheckBox(app, text="check 1", variable=check_var, onvalue="on", offvalue="off", textvariable=txt_var,
...
check_2 = timetablinggui.GUICheckBox(app, text="check 2", variable=check_var, onvalue="on", offvalue="off")
check_2.pack(pady=15)
if TEST_CONFIGURE: check_2.configure(variable=check_var)
if TEST_REMOVING: check_2.configure(variable="")

label_3 = timetablinggui.GUILabel(app, width=200, textvariable=check_var)
...
switch_1 = timetablinggui.GUISwitch(master=app, variable=s_var, textvariable=s_var, onvalue="on", offvalue="off", command=switch_event)
switch_1.pack(pady=20, padx=10)
switch_2 = timetablinggui.GUISwitch(master=app, variable=s_var, textvariable=s_var, onvalue="on", offvalue="off")
switch_2.pack(pady=20, padx=10)

optionmenu_var = tkinter.StringVar(value="test")
optionmenu_1 = timetablinggui.GUIOptionMenu(master=app, variable=None, values=["Option 1", "Option 2", "Option 3"])
optionmenu_1.pack(pady=20, padx=10)
optionmenu_1.configure(variable=optionmenu_var)
combobox_1 = timetablinggui.GUIComboBox(master=app, values=["Option 1", "Option 2", "Option 3"])
combobox_1.pack(pady=20, padx=10)
combobox_1.configure(variable=optionmenu_var)

radio_1 = timetablinggui.GUIRadioButton(app, textvariable=txt_var)
