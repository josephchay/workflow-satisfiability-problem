...
from .widgets.scaling import GUIScalingBaseClass
from .widgets.appearance_mode import GUIAppearanceModeBaseClass

from timetablinggui.windows.widgets.utility.utility_functions import pop_from_dict_by_set, check_kwargs_empty

GUI_PARENT_CLASS = tkinter.Tk


class TimetablingGUI(GUI_PARENT_CLASS, GUIAppearanceModeBaseClass, GUIScalingBaseClass):
    """
    ...
    def __init__(self,
        ...
        GUI_PARENT_CLASS.__init__(self, **pop_from_dict_by_set(kwargs, self._valid_tk_constructor_arguments))
        GUIAppearanceModeBaseClass.__init__(self)
        GUIScalingBaseClass.__init__(self, scaling_type="window")
        ...
        self._fg_color = ThemeManager.theme["GUI"]["fg_color"] if fg_color is None else self._check_color_type(fg_color)
        ...
        # set timetablinggui titlebar icon (Windows only)
    ...
    def _windows_set_titlebar_icon(self):
        try:
            ...
            if not self._iconbitmap_method_called:
                timetablinggui_directory = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
                self.iconbitmap(os.path.join(timetablinggui_directory, "assets", "icons", "timetablinggui_icon_Windows.ico"))
        except Exception:
            pass
