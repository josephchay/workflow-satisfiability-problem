...
class GUIScrollbar(GUIBaseClass):
    """
    ...
    def __init__(self,
        ...
        # color
        self._fg_color = ThemeManager.theme["GUIScrollbar"]["fg_color"] if fg_color is None else self._check_color_type(fg_color, transparency=True)
        self._button_color = ThemeManager.theme["GUIScrollbar"]["button_color"] if button_color is None else self._check_color_type(button_color)
        self._button_hover_color = ThemeManager.theme["GUIScrollbar"]["button_hover_color"] if button_hover_color is None else self._check_color_type(button_hover_color)

        # shape
        self._corner_radius = ThemeManager.theme["GUIScrollbar"]["corner_radius"] if corner_radius is None else corner_radius
        self._border_spacing = ThemeManager.theme["GUIScrollbar"]["border_spacing"] if border_spacing is None else border_spacing
