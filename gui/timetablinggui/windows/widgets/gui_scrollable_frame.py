...
class GUIScrollableFrame(tkinter.Frame, GUIAppearanceModeBaseClass, GUIScalingBaseClass):
    def __init__(self,
                 master: Any,
                 width: int = 200,
                 height: int = 200,
                 ...
                 label_text: str = "",
                 label_font: Optional[Union[tuple, GUIFont]] = None,
        ...
        self._parent_frame = GUIFrame(master=master, width=0, height=0, corner_radius=corner_radius,
        ...
        if self._orientation == "horizontal":
            self._scrollbar = GUIScrollbar(master=self._parent_frame, orientation="horizontal", command=self._parent_canvas.xview,
            ...
            self._scrollbar = GUIScrollbar(master=self._parent_frame, orientation="vertical", command=self._parent_canvas.yview,
                                           fg_color=scrollbar_fg_color, button_color=scrollbar_button_color, button_hover_color=scrollbar_button_hover_color)
            self._parent_canvas.configure(yscrollcommand=self._scrollbar.set)

        self._label_text = label_text
        self._label = GUILabel(self._parent_frame, text=label_text, anchor=label_anchor, font=label_font,
                               corner_radius=self._parent_frame.cget("corner_radius"), text_color=label_text_color,
                               fg_color=ThemeManager.theme["GUIScrollableFrame"]["label_fg_color"] if label_fg_color is None else label_fg_color)
    ...
    def configure(self, **kwargs):
        ...
        if "fg_color" in kwargs:
            ...
            for child in self.winfo_children():
                if isinstance(child, GUIBaseClass):
