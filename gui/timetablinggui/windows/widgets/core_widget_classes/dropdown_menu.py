...
class DropdownMenu(tkinter.Menu, GUIAppearanceModeBaseClass, GUIScalingBaseClass):
    ...
    def _check_font_type(font: any):
        if isinstance(font, GUIFont):
            ...
            raise ValueError(f"Wrong font type {type(font)} for font '{font}'\n" +
                             f"For consistency, timetablinggui requires the font argument to be a tuple of len 2 or 3 or an instance of GUIFont.\n" +
                             f"\nUsage example:\n" +
