...
class GUIComboBox(GUIBaseClass):
    """
    ...
    def __init__(self,
                 ...
                 dropdown_font: Optional[Union[tuple, GUIFont]] = None,
        ...
        # shape
        self._corner_radius = ThemeManager.theme["GUIComboBox"]["corner_radius"] if corner_radius is None else corner_radius
        self._border_width = ThemeManager.theme["GUIComboBox"]["border_width"] if border_width is None else border_width

        # color
        self._fg_color = ThemeManager.theme["GUIComboBox"]["fg_color"] if fg_color is None else self._check_color_type(fg_color)
        self._border_color = ThemeManager.theme["GUIComboBox"]["border_color"] if border_color is None else self._check_color_type(border_color)
        self._button_color = ThemeManager.theme["GUIComboBox"]["button_color"] if button_color is None else self._check_color_type(button_color)
        self._button_hover_color = ThemeManager.theme["GUIComboBox"]["button_hover_color"] if button_hover_color is None else self._check_color_type(button_hover_color)
        self._text_color = ThemeManager.theme["GUIComboBox"]["text_color"] if text_color is None else self._check_color_type(text_color)
        self._text_color_disabled = ThemeManager.theme["GUIComboBox"]["text_color_disabled"] if text_color_disabled is None else self._check_color_type(text_color_disabled)
        ...
        if self._variable is None:
            if len(self._values) > 0:
                ...
                self._entry.insert(0, "GUIComboBox")
