...
class GUIOptionMenu(GUIBaseClass):
    """
    ...
    def __init__(self,
        ...
        # color variables
        self._fg_color = ThemeManager.theme["GUIOptionMenu"]["fg_color"] if fg_color is None else self._check_color_type(fg_color)
        self._button_color = ThemeManager.theme["GUIOptionMenu"]["button_color"] if button_color is None else self._check_color_type(button_color)
        self._button_hover_color = ThemeManager.theme["GUIOptionMenu"]["button_hover_color"] if button_hover_color is None else self._check_color_type(button_hover_color)

        # shape
        self._corner_radius = ThemeManager.theme["GUIOptionMenu"]["corner_radius"] if corner_radius is None else corner_radius

        # text and font
        self._text_color = ThemeManager.theme["GUIOptionMenu"]["text_color"] if text_color is None else self._check_color_type(text_color)
        self._text_color_disabled = ThemeManager.theme["GUIOptionMenu"]["text_color_disabled"] if text_color_disabled is None else self._check_color_type(text_color_disabled)
        ...
        if len(self._values) > 0:
            ...
            self._current_value = "GUIOptionMenu"
