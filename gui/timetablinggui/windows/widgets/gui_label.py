...
class GUILabel(GUIBaseClass):
    ...
    def __init__(self,
                 ...
                 image: Union[GUIImage, None] = None,
                 compound: str = "center",
        ...
        # color
        self._fg_color = ThemeManager.theme["GUILabel"]["fg_color"] if fg_color is None else self._check_color_type(fg_color, transparency=True)
        self._text_color = ThemeManager.theme["GUILabel"]["text_color"] if text_color is None else self._check_color_type(text_color)

        if text_color_disabled is None:
            if "text_color_disabled" in ThemeManager.theme["GUILabel"]:
                self._text_color_disabled = ThemeManager.theme["GUILabel"]["text_color"]
            else:
        ...
        # shape
        self._corner_radius = ThemeManager.theme["GUILabel"]["corner_radius"] if corner_radius is None else corner_radius
