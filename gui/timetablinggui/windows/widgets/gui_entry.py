...
class GUIEntry(GUIBaseClass):
    ...
    def __init__(self,
        ...
        # color
        self._fg_color = ThemeManager.theme["GUIEntry"]["fg_color"] if fg_color is None else self._check_color_type(fg_color, transparency=True)
        self._text_color = ThemeManager.theme["GUIEntry"]["text_color"] if text_color is None else self._check_color_type(text_color)
        self._placeholder_text_color = ThemeManager.theme["GUIEntry"]["placeholder_text_color"] if placeholder_text_color is None else self._check_color_type(placeholder_text_color)
        self._border_color = ThemeManager.theme["GUIEntry"]["border_color"] if border_color is None else self._check_color_type(border_color)

        # shape
        self._corner_radius = ThemeManager.theme["GUIEntry"]["corner_radius"] if corner_radius is None else corner_radius
        self._border_width = ThemeManager.theme["GUIEntry"]["border_width"] if border_width is None else border_width
    ...
    def configure(self, require_redraw=False, **kwargs):
        ...
        super().configure(require_redraw=require_redraw, **kwargs)  # configure GUIBaseClass
    ...
    def cget(self, attribute_name: str) -> any:
        if attribute_name == "corner_radius":
            ...
            return super().cget(attribute_name)  # cget of GUIBaseClass
