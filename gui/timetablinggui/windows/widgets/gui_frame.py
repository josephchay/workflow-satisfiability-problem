...
class GUIFrame(GUIBaseClass):
    ...
    def __init__(self,
        ...
        if fg_color is None:
            if isinstance(self.master, GUIFrame):
                if self.master._fg_color == ThemeManager.theme["GUIFrame"]["fg_color"]:
    ...
    def winfo_children(self) -> List[any]:
        """
        winfo_children of GUIFrame without self.canvas widget,
        because it's not a child but part of the GUIFrame itself
        """
    ...
    def configure(self, require_redraw=False, **kwargs):
        if "fg_color" in kwargs:
            ...
            # check if GUI widgets are children of the frame and change their bg_color to new frame fg_color
