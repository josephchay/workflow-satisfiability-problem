...
class GUIProgressBar(GUIBaseClass):
    """
    ...
    def __init__(self,
        ...
        # color
        self._border_color = ThemeManager.theme["GUIProgressBar"]["border_color"] if border_color is None else self._check_color_type(border_color)
        self._fg_color = ThemeManager.theme["GUIProgressBar"]["fg_color"] if fg_color is None else self._check_color_type(fg_color)
        self._progress_color = ThemeManager.theme["GUIProgressBar"]["progress_color"] if progress_color is None else self._check_color_type(progress_color)
        ...
        # shape
        self._corner_radius = ThemeManager.theme["GUIProgressBar"]["corner_radius"] if corner_radius is None else corner_radius
        self._border_width = ThemeManager.theme["GUIProgressBar"]["border_width"] if border_width is None else border_width
