...
class GUIFont(Font):
    ...
    def __init__(self,
        ...
        self._size = ThemeManager.theme["GUIFont"]["size"] if size is None else size

        super().__init__(family=ThemeManager.theme["GUIFont"]["family"] if family is None else family,
                         size=-abs(self._size),
                         weight=ThemeManager.theme["GUIFont"]["weight"] if weight is None else weight,
                         slant=slant,
                         underline=underline,
