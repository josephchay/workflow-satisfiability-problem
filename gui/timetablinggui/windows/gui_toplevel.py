...
class GUIToplevel(tkinter.Toplevel, GUIAppearanceModeBaseClass, GUIScalingBaseClass):
    """
    ...
    def __init__(self, *args,
        ...
        try:
            ...
            if sys.platform.startswith("win"):
                ...
                self.after(200, lambda: self.iconbitmap(os.path.join(timetablinggui_directory, "assets", "icons", "timetablinggui_icon_Windows.ico")))
        except Exception:
            pass
